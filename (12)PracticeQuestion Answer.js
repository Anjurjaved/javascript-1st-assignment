//1. Create 3 variables of number and find out which one is large.var first_nmbr = prompt("Enter First Number")
...
//2. Calculate the average of 5 numbers. function  avarege(num_1,Num_2,Num_3) 
{
...
//3. Take input of birth month in number from the prompt and translate it to String like January, February. Print the translated value.
